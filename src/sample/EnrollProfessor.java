...
public class EnrollProfessor implements Initializable {
    ...
    public void Add_users () {
        ...
        String sql = "insert into profesori (id,username,password,nume,prenume) values (?,?,?,?,?)";
        try {
            ...
            alert.setTitle("Professor Added");
    ...
    public void Delete_users () {
        ...
        try {
            ...
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.initStyle(StageStyle.UTILITY);
            alert.setTitle("Professor Deleted");
            alert.setHeaderText(null);
            alert.setContentText("Professor deleted successfully!");
            alert.showAndWait();
    ...
    public void Update_users() {
        ...
        conn = mysqlconnect.ConnectDB();
        String sql = "update profesori set id = ?,username = ?,password = ?,nume = ?,prenume = ? where id = ?";
        try {
            ...
            Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.initStyle(StageStyle.UTILITY);
            alert.setTitle("Professor Updated");
            alert.setHeaderText(null);
            alert.setContentText("Professor updated successfully!");
            alert.showAndWait();
...
//    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        listM = mysqlconnect.getDataprofesori();
